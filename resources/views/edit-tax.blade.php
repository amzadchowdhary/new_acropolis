        ...
        <x-auth-card>
            ...
            <form method="POST" action="{{ $url }}">
                ...
                <div>
                    ...
                    <x-text-input id="name" class="block mt-1 w-full" type="text" name="name" value="{{$tax->name}}" required autofocus />
                ...
                <div class="mt-4">
                    ...
                    <x-text-input id="pin_code" class="block mt-1 w-full" type="text" name="tax_percentage" value="{{$tax->tax_rate}}"  />
